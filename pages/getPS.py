...
query = "select ?s ?name where {?s <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://purl.org/vocab/cpsv#PublicService>. ?s <http://origin> '" + country + "'. ?s <http://purl.org/dc/terms/title> ?name}"
urls = g.query (query)
